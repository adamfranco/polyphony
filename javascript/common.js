 ...
 * @since 10/21/08
 */
document.getChildrenByTagName = function (targetElement, tagName) {
	var results = [];
 ...
 * @param optional Element rootElement
 * @return Array
 * @access public
 * @since 10/2/08
 */
document.get_elements_by_class = function (className, rootElement) {
	if (rootElement)
