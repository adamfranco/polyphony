...
require_once(dirname(__FILE__)."/viewfile.act.php");

/**
 * This Action will return a file if the user is authorized, but will fail and
	...
	extends ConditionalGetAction
{
	...
	public function __construct () {
		$this->surrogate = new viewfileAction;
	}
